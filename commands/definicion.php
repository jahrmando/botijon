<?php
class definicion extends command {
	...
	public function help(){
		return "Uso: !definicion <criterio de búsqueda> . Devuelve los 3 primeros resultados que arroja google al realizar una consulta tipo 'define', la cual toma en cuenta definiciones tipo diccionario.";
	}
